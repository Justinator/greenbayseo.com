...
content_blocks:
  - _bookshop_name: hero-split
    preheading: Reputation Management in Green Bay, WI
    heading: Stop Waiting for Customers to Leave Reviews on Their Own
    subheading: 
    body: >-
      Reputation management in Green Bay, WI should be more than checking your Google reviews every once in a while. Without a consistent system for asking customers for reviews, even your happiest customers will stay silent. Green Bay Ranking Co. helps you identify your review gap, create outreach templates, set up direct review links, plan follow-up sequences and manage ongoing responses. This way, reputation management doesn’t keep falling to the bottom of your to-do list.
    image:
  ...
  - _bookshop_name: intro
    ...
    body: >-
      ...
      * Following up when the first request is ignored
      
      * Directing customers to the review platforms that matter most
      
      * Encouraging detailed, useful feedback
      
      * Responding consistently to positive reviews
      
      * Handling negative reviews thoughtfully with your team’s input
      
      
      You stay focused on running your business. We help make sure your online reputation doesn’t get neglected.
    button:
      enabled: false
      button_url: ''
      button_text: ''
  ...
  - _bookshop_name: steps
    ...
    steps: 
      ...
      - number: 3
        ...
        body: >-
          Once we understand the gap, we can establish a monthly review target based on your market instead of using an arbitrary number.
      - number: 4
      ...
      - number: 5
        ...
        body: >-
          We help monitor new feedback and keep responses from getting overlooked. Positive reviews can typically be handled directly, while negative reviews are reviewed with your team so we can respond with the right context.
  ...
  - _bookshop_name: one-column
    preheading: 
    heading: If Reviews Keep Falling Through the Cracks, It’s Probably Time for a Better System
    body: >-
      You don’t need to be dealing with a reputation crisis to benefit from reputation management. In many cases, the problem is much simpler. Your business is doing good work, but your online reviews don’t consistently reflect it. Reputation management may be a good fit if:
      

      * Your competitors have significantly more Google reviews than you do
      
      * You go weeks or months without receiving new reviews
      
      * Your team forgets to ask customers for feedback
      
      * You ask once, but rarely follow up
      
      * Reviews come in, but nobody consistently responds to them
      
      * You have plenty of happy customers but very little recent proof online
      
      * You aren’t sure which review platforms deserve your attention
      
      * Negative reviews sit unanswered because nobody knows how to respond
      
      * Review management keeps getting pushed behind more urgent day-to-day work
      
      * You want a clear monthly review goal instead of simply trying to “get more”
      
      
      If several of those sound familiar, the issue probably isn’t that your customers are unhappy. It’s that you don’t yet have a consistent process for turning good customer experiences into visible, credible reviews. That’s what we help build.
    button:
      enabled: false
      button_url: ''
      button_text: ''
  ...
  - _bookshop_name: call-to-action
    ...
    button_2:
      ...
      open_in_new_tab: false
  - _bookshop_name: one-column
    preheading: Google Review Management in Green Bay
    heading: How Far Behind Are You Compared With the Businesses Customers See Next to You?
    body: >-
      Getting more Google reviews is a good goal, but “more” doesn’t tell you much. One of the first things we do is look at how your business compares with other companies in your local market. We review your current Google rating, review count, review velocity and how those numbers stack up against competitors in your industry. Instead of telling you that you simply “need more reviews,” we help answer questions like:
      

      * How does your review count compare with local competitors?
      
      * Are competitors earning reviews more consistently than you are?
      
      * Is your rating competitive for your market?
      
      * How large is the review gap?
      
      * How many new reviews should you realistically aim for each month?
      
      * Are there other review platforms worth prioritizing alongside Google?
      
      
      This benchmark becomes the foundation for the rest of the strategy. We can then work backward from the gap and create an outreach plan designed to help you steadily improve your position over time.
    button:
      enabled: false
      button_url: ''
      button_text: ''
  ...
  - _bookshop_name: media-text
    ...
    body: >-
      ...
      * After a customer sends positive feedback by email or text
      
      * After someone tells your team they were happy with the experience
      
      * At another natural point when the customer has recently seen the value of your service
      
      
      We can also create the outreach templates and direct review links your team needs, so employees aren’t rewriting the request every time or searching for the correct Google or Yelp URL. Make asking for reviews part of the process instead of something your team remembers to do occasionally.
    button:
      enabled: false
      button_url:
      button_text:
  ...
  - _bookshop_name: call-to-action
    ...
    button_2:
      ...
      open_in_new_tab: false
  - _bookshop_name: one-column
    preheading: Reputation Management and Local SEO
    heading: Reviews Can Help Reinforce What Your Business Is Known For
    body: >-
      ...
      * The type of problem the customer had
      ...
      * Why they would recommend the business
      ...
      That makes the review more helpful to a prospective customer who is comparing local companies. It can also strengthen the overall body of information associated with your business across Google and other third-party platforms.
    ...
    css_class: ''
  - _bookshop_name: faq
    preheading: Reputation Management FAQs
    ...
    questions: 
      ...
      - question: How Many Times Should We Follow Up on a Review Request?
        answer: >-
          Follow up on a review request 1–2 times after the initial request. Send the first reminder after 3–7 days and a final reminder about 7–14 days later if the customer has not responded. Stop requesting a review after the final follow-up to avoid frustrating customers or making the request feel excessive. 
