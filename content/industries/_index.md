...
content_blocks:
  - _bookshop_name: hero-split
    preheading: 
    heading: Get Found by More Customers Searching for Your Services
    subheading: 
    body: >-
      Your customers are already searching Google for the services you provide. The challenge is making sure your business shows up when those searches happen. We help local service businesses improve visibility in Google Maps and organic search with industry-focused SEO built around high-intent services, local markets, and lead generation.
    image:
